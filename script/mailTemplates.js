...
let setUp = function(template, username, email, id, newPw) {
    switch(template) {
        case "verify":
            docUser = username
            docEmail = email
            docId = id 
            let verificationEmail = `<div style="font-family: sans-serif; background: #fafafa; height: 100%; padding: 0; margin: 0; width: auto; text-align: justify; color: black; "><p style="text-align:center;margin-bottom:30px"><img style="width: 80%; max-width: 300px;" src="https://ci6.googleusercontent.com/proxy/FG7ctqNaQRwB3iMUQZeNSoZtjZ6cS1LWu82SXpQTuaQ9JA58phu88pdMcKPp1rcL0IHAm3VkndYPMo0=s0-d-e1-ft#https://i.postimg.cc/Jn7XtPZY/EVAK01.png" alt="EVAK_main_logo" tabindex="0">
</p>
...
<p style="text-align:center;color:#969696">
    ...
    küldtük. Amennyiben tévesen kapta, kérjük jelezze nekünk e-mail-ben!
        ...
        case "pwrecovery":
            let recoveryEmail = `<div
            style="font-family: sans-serif; background: #fafafa; height: 100%; padding: 0; margin: 0; width: auto; text-align: justify; color: black; ">
            <p style="text-align:center;margin-bottom:30px"><img style="width: 80%; max-width: 300px;"
                    src="https://ci6.googleusercontent.com/proxy/FG7ctqNaQRwB3iMUQZeNSoZtjZ6cS1LWu82SXpQTuaQ9JA58phu88pdMcKPp1rcL0IHAm3VkndYPMo0=s0-d-e1-ft#https://i.postimg.cc/Jn7XtPZY/EVAK01.png"
                    alt="EVAK_main_logo" tabindex="0">
            </p>
        
            <h1 style="text-align: center;">Jelszó visszaállítás ${username} számára.</h1>
        
            <p>Jelszó visszaállítást igényeltek erre az email címre.</p><br>
            <p>Az Ön új jelszava, amivel be tud jelentkezni:</p><br>
            <h1>${newPw}</h1>
            <p>Amint bejelentkezett meg kell változtassa ezt a jelszót.</p><br>
        
            <a style="padding:20px; background:#ccff00;border-radius:5px;display: block;position: relative; text-decoration:none;font-family:sans-serif;font-weight:700;color:black; text-align: center; align-content: center;"
                href="https://www.evak.hu/" target="_blank">Bejelentkezés az EVAK rendszerbe</a><br>
            <p style="text-decoration:none;color:grey"><a href="https://www.evak.hu/"
                    target="_blank">https://www.evak.hu/</a>
            </p>
            ...
            <hr style="border:2px solid #eaeef3;border-bottom:0;margin:20px 0">
            <p style="text-align:center;color:#969696">
                Ezt a levelet a '<a href="mailto:${email}" target="_blank">${email}</a>' címre
                küldtük. Amennyiben tévesen kapta, kérjük jelezze nekünk e-mail-ben!
            </p>
        </div>`
